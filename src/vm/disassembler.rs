...
impl<'a> Disassembler<'a> {
    ...
    pub fn disassemble_op(&self, op_idx: usize, level: usize) -> (usize, String, String) {
        ...
        let (op_idx_inc, op_str): (usize, String) = match self.chunk.ops[op_idx] {
            ...
            op::ACCESS => self.disassemble_op_simple("OP_ACCESS"),
            op::PRIVATE => self.disassemble_op_simple("OP_PRIVATE"),
            op::PUBLIC => self.disassemble_op_simple("OP_PUBLIC"),
    ...
    assert_disassembly! {
        ...
        class_init_and_method_call: (
            ...
            concat!(
                ...
                "0010 OP_PUBLIC\n",
                "0011 OP_POP\n",
                "0012 OP_GET_GLOBAL       0 == 'Greeter'\n",
                "0014 OP_CLOSURE          2 == '<fn init arity=1>'\n",
                "| 0000 OP_GET_LOCAL        1\n",
                "| 0002 OP_GET_LOCAL        0\n",
                ...
                "| 0007 OP_GET_LOCAL        0\n",
                "| 0009 OP_RETURN\n",
                "0016 OP_METHOD           3 == 'init'\n",
                "0018 OP_ACCESS\n",
                "0019 OP_PUBLIC\n",
                "0020 OP_CLOSURE          4 == '<fn greet arity=1>'\n",
                "| 0000 OP_GET_LOCAL        0\n",
                ...
                "| 0009 OP_ADD\n",
                "| 0010 OP_RETURN\n",
                "0022 OP_METHOD           5 == 'greet'\n",
                "0024 OP_ACCESS\n",
                "0025 OP_PUBLIC\n",
                "0026 OP_POP\n",
                "0027 OP_GET_GLOBAL       0 == 'Greeter'\n",
                "0029 OP_CONSTANT         6 == 'Hello'\n",
                "0031 OP_CALL             1\n",
                "0033 OP_DEFINE_GLOBAL    7 == 'greeter'\n",
                "0035 OP_GET_GLOBAL       7 == 'greeter'\n",
                "0037 OP_GET_PROPERTY     5 == 'greet'\n",
                "0039 OP_CONSTANT         8 == 'World'\n",
                "0041 OP_CALL             1\n",
                "0043 OP_PRINT\n",
                "0044 OP_NIL\n",
                "0045 OP_RETURN\n"
